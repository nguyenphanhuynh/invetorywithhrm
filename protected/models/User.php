...
class User extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('password, repeat_password', 'length', 'min' => 4, 'max' => 40),
            array('password', 'compare', 'compareAttribute' => 'repeat_password'),

            array('username, email, create_at', 'required'),
            ...
            array('id, username, password, email, activkey, create_at, lastvisit, status, gender', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function beforeSave()
    {
        ...
        } else if (!empty($this->password) && !empty($this->repeat_password))
...
//	}
    ...
    public function saveModel($data = array())
    {
        ...
        if (!empty($data['password']) && !empty($data['repeat_password']) && !empty($data['initialPassword'])) {
            $data['password'] = $this->hashPassword($data['password']);
            $data['repeat_password'] = $this->hashPassword($data['repeat_password']);
        }
